  ...
  return (
    ...
    <div className='bg-slate-600'>
      ...
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        ...
        Singh Estate is the best place to find your next perfect place to
          live.
          <br />
        ...
        {offerListings && offerListings.length > 0 && (
          <div className=''>
            <div className='my-3'>
              ...
              <Link className='text-sm text-amber-500 font-semibold hover:underline' to={'/search?offer=true'}>Show more offers</Link>
            </div>
        ...
        {rentListings && rentListings.length > 0 && (
          <div className=''>
            <div className='my-3'>
              ...
              <Link className='text-sm  text-amber-500 font-semibold hover:underline' to={'/search?type=rent'}>Show more places for rent</Link>
            </div>
            <div className='flex flex-wrap gap-4'>
        ...
        {saleListings && saleListings.length > 0 && (
          <div className=''>
            <div className='my-3'>
              ...
              <Link className='text-sm  text-amber-500 font-semibold hover:underline' to={'/search?type=sale'}>Show more places for sale</Link>
            </div>
            <div className='flex flex-wrap gap-4'>
