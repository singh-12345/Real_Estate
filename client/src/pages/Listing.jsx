      ...
      {listing && !loading && !error && (
        ...
        <div>
          ...
          <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
            ...
            <ul className='text-slate-200 font-semibold text-sm flex flex-wrap items-center gap-4 sm:gap-6'>
            ...
            {currentUser && listing.userRef !== currentUser._id && !contact && (
              <button
                ...
                className='bg-teal-500 text-white rounded-lg uppercase hover:opacity-95 p-3'
              >
                Contact landlord
              </button>
             )}
