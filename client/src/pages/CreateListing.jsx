...
export default function CreateListing() {
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto bg-slate-500 mt-10 rounded-md'>
        ...
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <div className='flex gap-4'>
            ...
            <button
              ...
              className='p-3 text-orange-600 border border-slate-200 rounded uppercase hover:shadow-lg disabled:opacity-80'
            >
